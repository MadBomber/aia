# lib/aia/variable_input_collector.rb

require 'json'
require 'fileutils'

module AIA
  class VariableInputCollector
    def initialize
  ...
  # Backward-compatibility alias — prefer VariableInputCollector in new code.
  HistoryManager = VariableInputCollector
end
