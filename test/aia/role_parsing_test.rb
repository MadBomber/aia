...
class RoleParsingTest < Minitest::Test
  ...
  def teardown
    ...
    ENV.delete('AIA_ROLES_PREFIX')
  end

  # Test basic model parsing without roles
  def test_parse_single_model_without_role
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o')
  ...
  def test_parse_multiple_models_without_roles
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o,claude,gemini')
  ...
  def test_parse_single_model_with_role
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o=architect')
  ...
  def test_parse_multiple_models_with_roles
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o=architect,claude=security,gemini=performance')
  ...
  def test_parse_mixed_models_with_and_without_roles
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o=architect,claude,gemini=performance')
  ...
  def test_parse_duplicate_models_with_different_roles
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o=optimist,gpt-4o=pessimist,gpt-4o=realist')
  ...
  def test_parse_nested_role_path
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o=specialized/senior_architect')
  ...
  def test_parse_provider_syntax_with_role
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('ollama/llama2=architect,lms/gpt-4o=security')

    assert_equal 2, result.length

    assert_equal 'ollama/llama2', result[0][:model]
    assert_equal 'architect', result[0][:role]

    assert_equal 'lms/gpt-4o', result[1][:model]
    assert_equal 'security', result[1][:role]
  end

  # Test whitespace handling
  def test_parse_with_whitespace
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles('  gpt-4o = architect , claude = security  ')
  ...
  def test_parse_invalid_syntax_leading_equals
    error = assert_raises(ArgumentError) do
      AIA::ConfigModules::CLIParser.parse_models_with_roles('=architect')
    end
  ...
  def test_parse_invalid_syntax_trailing_equals
    error = assert_raises(ArgumentError) do
      AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o=')
    end
    assert_match(/Invalid model syntax/, error.message)
  end
  ...
  def test_validate_nonexistent_role
    error = assert_raises(ArgumentError) do
      AIA::ConfigModules::CLIParser.parse_models_with_roles('gpt-4o=nonexistent')
    end
  ...
  def test_list_available_role_names
    roles = AIA::ConfigModules::CLIParser.list_available_role_names(@temp_dir, 'roles')
  ...
  def test_complex_real_world_scenario
    result = AIA::ConfigModules::CLIParser.parse_models_with_roles(
