...
- [CLI Reference](#cli-reference)
  ...
  - [Mode Options](#mode-options)
    ...
    - [`--no-mcp`](#--no-mcp)
    - [`--mcp-list`](#--mcp-list)
    - [`--mu`, `--mcp-use NAMES`](#--mu---mcp-use-names)
    - [`--ms`, `--mcp-skip NAMES`](#--ms---mcp-skip-names)
  ...
  - [File Options](#file-options)
    - [`-c, --config-file FILE`](#-c---config-file-file)
    - [`-o, --[no-]output [FILE]`](#-o---no-output-file)
    - [`-a, --[no-]append`](#-a---no-append)
    - [`--[no-]history-file [FILE]`](#--no-history-file-file)
    - [`--md, --[no-]markdown`](#--md---no-markdown)
  - [Prompt Options](#prompt-options)
    - [`--prompts-dir DIR`](#--prompts-dir-dir)
  ...
  - [AI Parameters](#ai-parameters)
    - [`-t, --temperature TEMP`](#-t---temperature-temp)
    - [`--max-tokens TOKENS`](#--max-tokens-tokens)
    - [`--top-p VALUE`](#--top-p-value)
    - [`--frequency-penalty VALUE`](#--frequency-penalty-value)
    - [`--presence-penalty VALUE`](#--presence-penalty-value)
  - [Audio/Image Options](#audioimage-options)
    - [`--speak`](#--speak)
    - [`--voice VOICE`](#--voice-voice)
    - [`--is, --image-size SIZE`](#--is---image-size-size)
    - [`--iq, --image-quality QUALITY`](#--iq---image-quality-quality)
    - [`--style, --image-style STYLE`](#--style---image-style-style)
  - [Tool Options](#tool-options)
    - [`--rq LIBS, --require LIBS`](#--rq-libs---require-libs)
    - [`--tools PATH_LIST`](#--tools-path_list)
    - [`--at, --allowed-tools TOOLS_LIST`](#--at---allowed-tools-tools_list)
    - [`--rt, --rejected-tools TOOLS_LIST`](#--rt---rejected-tools-tools_list)
